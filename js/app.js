...
(() => {
  ...
  function renderAbout(){
    ...
    page.innerHTML = `
      <div class="section__head">
        <div>
          ...
          <div class="muted">Underground seed exchange • быстро • аккуратно • без лишних вопросов</div>
        </div>
      </div>
    `;
    ...
    about.innerHTML = `
      <div class="aboutTitle">О нас</div>
      <p class="aboutText">
    ...
    delivery.innerHTML = `
      ...
      <div class="aboutGrid">
        <div class="aboutCard neo">
          ...
          <div>
            <div class="aboutCard__name">По Москве</div>
            <div class="aboutCard__desc">Курьером — от 500 ₽</div>
          </div>
        </div>
